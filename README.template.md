...
```gradle
testImplementation("com.wesleyhome:junit-jupiter-params-generated:${version}")
```
...
```gradle
annotationProcessor("com.wesleyhome:junit-jupiter-params-generated-processor:${version}")
```
