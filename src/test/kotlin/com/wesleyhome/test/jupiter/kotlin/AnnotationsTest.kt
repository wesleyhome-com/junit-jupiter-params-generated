...
class AnnotationsTest {
  ...
  companion object {
    ...
    fun tester() {
      ...
      assertThat(getRef(LOCAL_DATE_TIME_SOURCE)).describedAs(LOCAL_DATE_TIME_SOURCE).containsOnly("2022-01-01T12:30", "2022-01-01T13:30")
      assertThat(getRef(LOCAL_DATE_TIME_SOURCE_WITH_PATTERN)).describedAs(LOCAL_DATE_TIME_SOURCE_WITH_PATTERN).containsOnly("2022-01-01T00:30", "2022-01-01T13:30")
