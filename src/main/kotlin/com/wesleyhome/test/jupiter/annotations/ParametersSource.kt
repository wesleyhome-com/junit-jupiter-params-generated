...
@Deprecated(
    message = "Deprecated in favor of GeneratedParametersTest which can run without @ParameterizedTest",
    replaceWith = ReplaceWith(expression = "@GeneratedParametersTest")
)
