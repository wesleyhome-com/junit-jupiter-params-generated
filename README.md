...
```gradle
testImplementation("com.wesleyhome:junit-jupiter-params-generated:3.0.1-SNAPSHOT")
```
...
```gradle
annotationProcessor("com.wesleyhome:junit-jupiter-params-generated-processor:3.0.1-SNAPSHOT")
```
